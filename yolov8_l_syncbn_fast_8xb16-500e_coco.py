_base_ = ('D:\YOLO\YOLO-World\\third_party\mmyolo\configs\yolov8\yolov8_l_syncbn_fast_8xb16-500e_coco.py')
...
coco_train_dataset = dict(_delete_=True,
                          ...
                          dataset=dict(
                              ...
                              data_root='D:\Dataset\coco2017labels-segments\coco',
...
val_evaluator = dict(_delete_=True,
                     ...
                     ann_file='D:\Dataset\coco2017labels-segments\coco\\annotations\instances_val2017.json',
                     metric='bbox')
